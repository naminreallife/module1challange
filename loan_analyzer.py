...
numberofloans = len(loan_costs)
print("Total Number of Loans: ", numberofloans)

# What is the total of all loans?
loantotal = sum(loan_costs)
print("Total Amount of Loans: $", loantotal)

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
averageloanprice = loantotal / numberofloans
print("The Average Loan Amount is: $", averageloanprice)
...
present_value = PV(new_loan["future_value"], new_loan["remaining_months"], annual_discount_rate=0.2)
